...
public:
	...
	virtual void addWeightingFunction( WeightingFunctionInstanceInterface* p1, const std::vector<QueryEvalInterface::FeatureParameter>& p2);
...
public:
	...
	virtual std::vector<SentenceGuess> call( const std::string& p1, int p2) const;
};
